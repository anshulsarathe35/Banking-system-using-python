...
while True:
    speak("please enter the correct password, to excess to the banking system")
    password = input("PASSWORD :")
    if password == "abcdef":
        speak("ACCESS GRANTED , YOU ARE DIRECTING TO THE  BANKING SYSTEM")
...
def crdt_write(master,amt,accnt,name):
	...
	frec.close()
	speak("Amount credited successfully")
...
def debit_write(master,amt,accnt,name):
	...
	if(int(amt)>camt):
		...
		frec.write(str(strftime("[%Y-%m-%d] [%H:%M:%S]  ",gmtime()))+"     "+"              "+str(amti)+"              "+str(cb)+"\n")
		frec.close()
		speak("amount debited successfully")
...
def Cr_Amt(accnt,name):
	...
	creditwn.configure(bg="#FF1493")
	fr1=tk.Frame(creditwn,bg="blue")
	l_title=tk.Message(creditwn,text=" BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	debitwn.configure(bg="#FF1493")
	fr1=tk.Frame(debitwn,bg="blue")
	l_title=tk.Message(debitwn,text=" BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def disp_tr_hist(accnt):
	...
	disp_wn.configure(bg="#FF0000")
	fr1=tk.Frame(disp_wn,bg="blue")
	l_title=tk.Message(disp_wn,text=" BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	fr1=tk.Frame(disp_wn)
	fr1.pack(side="top")
	l1=tk.Message(disp_wn,text="Your Transaction History:",padx=100,pady=20,width=1000,bg="yellow",fg="black",relief="raised")
	l1.pack(side="top")
...
def logout(master):
	...
	speak("you have been successfully logged out!!")
...
def log_in(master):
	...
	loginwn.configure(bg="#FF1493")
	fr1=tk.Frame(loginwn,bg="blue")
	l_title=tk.Message(loginwn,text=" BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	crwn.configure(bg="#FF1493")
	fr1=tk.Frame(crwn,bg="blue")
	l_title=tk.Message(crwn,text=" BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	rootwn.geometry("1600x500")
	rootwn.title(" Bank")
	rootwn.configure(background='#00BFFF')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(text=" BANKING\n SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
